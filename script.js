...
function getUserData(id) {
  ...
  return new Promise(async (res, rej) => {
    ...
    try {
      ...
      const specificDb = await dbs[dbName](id);
      ...
      if (typeof resultObj.address !== "object" || resultObj.address === null) {
        rej(`The address from vault database is incorrect`);
        return;
      }
      ...
      if (typeof resultObj.company !== "object" || resultObj.company === null) {
        rej(`The company data from specific database is incorrect`);
        return;
      }
